...
#include <memory>
#include "../03_SignalSlotTest/subwidget.h"
...
QT_MOC_LITERAL(1, 10, 6), // "Switch"
QT_MOC_LITERAL(2, 17, 0), // ""
QT_MOC_LITERAL(3, 18, 1), // "a"
QT_MOC_LITERAL(4, 20, 1) // "s"

    },
    "SubWidget\0Switch\0\0a\0s"
};
...
void SubWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Switch(); break;
        case 1: _t->Switch((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SubWidget::Switch)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SubWidget::Switch()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void SubWidget::Switch(int _t1, QString _t2)
{
